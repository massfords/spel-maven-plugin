...
//                    })
        ...
        report.createReportFile(new File(this.project.getModel().getBuild().getDirectory(), "spel-maven-plugin/report.json"));
        ...
        for(Method m : set) {
            ...
            if (expressionObj instanceof String) {
                ...
                try {
                    ...
                    String formatted = String.format(pattern, sa.getName(), sa.getAttribute(), expression, e.getMessage());
                    ...
                    String formatted = String.format(message, sa.getName(), sa.getAttribute(), expression, e.getMessage());
                    reportError(formatted);
                }
